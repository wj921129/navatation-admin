...
--
-- Table structure for table `navatation_nav_home_shortcut`
--
...
CREATE TABLE `navatation_nav_home_shortcut` (
  ...
  `type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'single' COMMENT '卡片类型：single-单一网址, stack-文件夹',
  `parent_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '父级ID（用于文件夹类型的堆叠，NULL表示顶层）',
  `sort_order` decimal(10,2) NOT NULL DEFAULT '0.00',
...
--
-- Table structure for table `navatation_recommend_home_shortcut`
--
...
--
-- Table structure for table `navatation_recommend_shortcut`
--
...
--
-- Table structure for table `navatation_recommend_todo_item`
--
...
--
-- Table structure for table `navatation_recommend_widget`
--
